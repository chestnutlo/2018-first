...
<body>
            ...
            <div class="container">
                ...
                <div class="col-sm-9" id="blog-post">
                    ...
                    <div class="box">
                        ...
                        <p class="lead">This is the lead paragraph of the article. Pellentesque habitant morbi tristique senectus et netus
                            et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget.</p>
                        ...
                        <div id="post-content">
                            <p>
                                ...
                                <code>commodo vitae</code>, ornare sit amet, wisi. Aenean fermentum, elit eget tincidunt condimentum, eros ipsum rutrum
                                orci, sagittis tempus lacus enim ac dui.
                                <a href="#">Donec non enim</a> in turpis pulvinar facilisis. Ut felis.</p>

                            <p>
                                <img src="imges/blog2.jpg" class="img-responsive" alt="Example blog post alt">
                            </p>
                            ...
                            <blockquote>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus magna. Cras in mi at felis
                                    ...
                                    libero at sagittis mollis, tellus est malesuada tellus, at luctus turpis elit sit amet
                            ...
                            <p>
                                <img src="imges/blog.jpg" class="img-responsive" alt="Example blog post alt">
                            </p>
                        ...
                        <div id="comments" data-animate="fadeInUp">
                            ...
                            <div class="row comment">
                                <div class="col-sm-3 col-md-2 text-center-xs">
                                    <p>
                                        <img src="imges/blog-avatar2.jpg" class="img-responsive img-circle" alt="">
                                    </p>
                                </div>
                                <div class="col-sm-9 col-md-10">
                                    <h5>Julie Alma</h5>
                                    <p class="posted">
                                        <i class="fa fa-clock-o"></i> September 23, 2011 at 12:00 am</p>
                            ...
                            <div class="row comment last">
                                ...
                                <div class="col-sm-3 col-md-2 text-center-xs">
                                    <p>
                                        <img src="imges/blog-avatar.jpg" class="img-responsive img-circle" alt="">
                                    </p>
                                </div>
                                ...
                                <div class="col-sm-9 col-md-10">
                                    <h5>Louise Armero</h5>
                                    <p class="posted">
                                        <i class="fa fa-clock-o"></i> September 23, 2012 at 12:00 am</p>
                                    <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis
                                        egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet,
                                        ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est.
                                        Mauris placerat eleifend leo.</p>
 ...
 _________________________________________________________ -->
                    ...
                    <div class="banner">
                        <a href="#">
                            <img src="imges/banner.jpg" alt="sales 2014" class="img-responsive">
                        </a>
                    </div>
                </div>
