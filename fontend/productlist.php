...
$query = $db->query("SELECT * FROM products WHERE product_categories_id=".$_GET['id']."" );
$product_list = $query->fetchAll(PDO::FETCH_ASSOC);

$query2 = $db->query("SELECT * FROM product_categories WHERE product_categories_id=".$_GET['id']."" );
$nav = $query2->fetch(PDO::FETCH_ASSOC);
?>
                                ...
                                <div class="flip-container">
                                    <div class="flipper" >
                                        ...
                                        <a href="product.php?id=<?php echo $product['products_id']; ?>" >
                                                <img src="../uploads/products/<?php echo $product['picture']; ?>" alt="" class="img-responsive" width='200' height='50' >
                                            </a>
                                        </div>
                                        <div class="back">
                                        <a href="product.php?id=<?php echo $product['products_id']; ?>" >
